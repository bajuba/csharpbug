...
namespace BugCrawl
{
    public class Box : Creature
    {
        ...
        {   
            ...
            if(this.Xpos == 9) {directionY = -1; direction=2;} //rand.Next(-1, 1);    
            if(this.Xpos == 0) {directionY = 1; direction=2;} //rand.Next(2);
            if(this.Ypos == 9) {directionX = -1; direction=2;} //rand.Next(-1, 1);
            if(this.Ypos == 0) {directionX = 1; direction=2;} //rand.Next(2);                     
